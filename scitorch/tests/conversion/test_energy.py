...
class TestToJoule(object):
    ...
    def test_to_joule_with_dimension(self):
        ...
        assert torch.equal(joule['val'], T([0, 3600])) and joule['dim'] == 'J'
